#!/usr/bin/env bash
#kubectl apply -f elastic_services/crds.yaml
#kubectl apply -f elastic_services/elastic-operator-all-in-one.yaml
...
kubectl delete -f elastic_services/elastic-operator-all-in-one.yaml
